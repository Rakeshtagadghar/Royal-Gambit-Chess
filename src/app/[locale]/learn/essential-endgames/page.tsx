...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: getLocaleAlternates(locale, "/learn/essential-endgames"),
    openGraph: {
      title: "Essential Endgames - Master Chess Endgame Technique | RoyalGambit",
      description:
      ...
      url: getLocaleUrl(locale, "/learn/essential-endgames"),
...
export default async function EssentialEndgamesPage({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  return (
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                item: `${BASE_URL}/${locale}/learn/essential-endgames`,
              },
            ],
          }),
        }}

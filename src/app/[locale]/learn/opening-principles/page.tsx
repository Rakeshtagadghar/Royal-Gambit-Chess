...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: getLocaleAlternates(locale, "/learn/opening-principles"),
    openGraph: {
      title: "Opening Principles - Master Chess Openings | RoyalGambit",
      description:
      ...
      url: getLocaleUrl(locale, "/learn/opening-principles"),
...
export default async function OpeningPrinciplesPage({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  return (
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                item: `${BASE_URL}/${locale}/learn/opening-principles`,
              },
            ],
          }),
        }}

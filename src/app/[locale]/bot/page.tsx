          ...
          >
            ...
            <Card className="mb-6">
              <CardHeader>
                ...
                <CardDescription>{t('difficultyDesc')}</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="mb-6">
              <CardHeader>
                <CardTitle className="text-lg">{t('playAs')}</CardTitle>
                <CardDescription>{t('playAsDesc')}</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex gap-2">
                  {(
                    [
                      { value: 'white', labelKey: 'white', emoji: '♔' },
                      { value: 'black', labelKey: 'black', emoji: '♚' },
                      { value: 'random', labelKey: 'random', emoji: '🎲' },
                    ] as const
                  ).map((option) => (
                    <Button
                      key={option.value}
            ...
            <Card className="mb-8">
              <CardHeader>
                <CardTitle className="text-lg">{t('timeControl')}</CardTitle>
                <CardDescription>{t('timeControlDesc')}</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-2 sm:grid-cols-5 gap-2">
          ...
          <div className="flex-1">
            ...
            >
              ...
              <div className="w-full max-w-[560px] mt-2">
                <PlayerCard
                  color={humanColor}
                  username={profile?.username || t('guest')}
            ...
            <Card>
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-lg">{t('gameInfo')}</CardTitle>
                  <span className={cn(
                    'text-sm px-2 py-1 rounded',
                    status === 'active' ? 'bg-green-500/20 text-green-500' : 'bg-muted text-muted-foreground'
                  )}>
                    {status === 'active' ? t('inProgress') : status === 'finished' ? t('finished') : status}
                  </span>
                </div>
              </CardHeader>

    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <main className="container mx-auto px-4 py-8 text-center">
          ...
          <p className="text-muted-foreground mb-4">{gameError || 'Game not found'}</p>
  ...
  if (game.status !== 'finished') {
    return (
      <div className="min-h-screen bg-background">
        <Navbar />
        <main className="container mx-auto px-4 py-8 text-center">
          <h1 className="text-2xl font-bold mb-4">Game Not Finished</h1>
          <p className="text-muted-foreground mb-4">
            Game review is only available for finished games.
          </p>
            ...
            {analysisStatus === 'not_requested' && (
              <Card className="mb-4">
                <CardContent className="py-6 text-center">
                  ...
                  <h3 className="font-semibold mb-2">No Analysis Available</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Request a game analysis to see move-by-move evaluation.
                  </p>
              ...
              <Card className="mb-4">
                <CardContent className="py-6 text-center">
                  ...
                  <h3 className="font-semibold mb-2">
                    {analysisStatus === 'pending' ? 'Analysis Queued' : 'Analyzing Game...'}
                  </h3>
                  <p className="text-sm text-muted-foreground mb-2">
                    {analysisStatus === 'pending'
                      ? 'Your game is in the analysis queue.'
                      : `Analyzing move ${progress?.current_ply || 0} of ${progress?.total_plies || '?'}`}
                  </p>
                  {progress && (
            ...
            {analysisStatus === 'failed' && (
              <Card className="mb-4 border-red-500/50">
                <CardContent className="py-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    {reviewError || 'An error occurred during analysis.'}
                  </p>
                ...
                <CardContent>
                  <Tabs defaultValue="moves" className="w-full">
                    <TabsList className="grid w-full grid-cols-2">
                      <TabsTrigger value="moves">Move List</TabsTrigger>
                  ...
                  {analysis && (
                    <>
                      ...
                      <div className="text-xs text-muted-foreground space-y-1">
                        <div>
                          Engine: {analysis.engine_name} {analysis.engine_version}
                        </div>
                        <div>Depth: {analysis.analysis_depth}</div>
                        {analysis.completed_at && (
                          <div>
                            Analyzed: {new Date(analysis.completed_at).toLocaleDateString()}
                          </div>
                        )}
                      </div>
                    </>
